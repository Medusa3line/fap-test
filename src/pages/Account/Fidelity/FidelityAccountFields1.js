...
const AccountFields1 = ({
    bvn, onChangeBVN, showValidateBVNButton, firstName, 
    lastName, dob, gender, onChange, 
    onSubmit, middleName, title, maritalStatus,
    isThereBvn, hasBVN, showAccountOpeningFields, validateBvn }) => {
    return (
        <div className="row">                
            ...
            }
            {
                ...
                <form className="form" onSubmit={onSubmit}>
                    <div className="form-group">
                        <div className="col-sm-12 col-md-12 col-lg-12" style={{marginBottom: '2vh'}}>
                            <select className="form-control" required="required" onChange={onChange} value={title} name="title">
