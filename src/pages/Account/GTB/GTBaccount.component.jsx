...
import AccountFields1 from './GTBAccountFields1';
import AccountFields2 from './GTBAccountFields2';
import AccountOpeningSuccess from './GTBAccountOpeningSuccess';

class GTBaccount extends Component {
    constructor(){
      super()
      this.state = {
        route: 'page1',
