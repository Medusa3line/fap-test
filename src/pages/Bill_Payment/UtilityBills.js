...
manipulateNumber = (e) => {
  ...
  render() {
    ...
    const { options, makingPayment, serviceNames, optionName, validDeviceNumber, customerName, amount } = this.state;
    return (
        <div>
              ...
              <React.Fragment>
                ...
                <form className="form-horizontal">
                  <div className="form-group">
                    <input className="form-control" type="number" name="" value={amount} maxLength="8" required="required" placeholder="Enter Amount" onChange={this.amount} onKeyPress={(e) => manipulateNumber(e)} />
                  </div>
                  <div className="form-group">
                    <input className="form-control" type="number" name="" required="required" placeholder="Enter Meter Number" onChange={this.deviceNumber} onKeyPress={(e) => manipulateNumber(e)} maxLength="25" /> 
                  </div>
                  {
                    validDeviceNumber ? 
                    <div className="form-group">
