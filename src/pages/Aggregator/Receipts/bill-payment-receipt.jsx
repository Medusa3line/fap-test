...
class BillPaymentReceipt extends Component {
	...
	componentDidMount = async () => {
		...
		if (!this.props.history.location.state){
			...
			console.log(this.props.history.location.state.agent)
			await this.setState({
				DTO: this.props.history.location.state.agent.utilityDTO
			})
			await this.setState({
				transaction: this.props.history.location.state.agent, 
				tranDate: this.props.history.location.state.agent.tranDate,
				electricityToken: this.props.history.location.state.agent.utilityDTO.electricityToken
			})
