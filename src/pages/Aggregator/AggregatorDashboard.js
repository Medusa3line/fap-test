...
class AggregatorDashbaord extends Component{
    _isMounted = false;
    today = new Date();
...
logout = () => { localStorage.clear(); if(this._isMounted){ alert('Your session timed out'); this.props.history.push("/"); } };
...
export default AggregatorDashbaord;