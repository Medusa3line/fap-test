...
class AgentTradingWallet extends Component {
  _isMounted = false;
  constructor(){
    super()
    this.state = {
  ...
  fetchHistory = async (reqBody) => {
    ...
    await fetch(`${baseUrl}/wallet/walletHistory/trading`, {
      method: 'post',
      headers: {
            ...
            <div className="container">
              <div className="row" id="aggregator-container">
                <div className="row" style={{marginLeft: '0'}} id="back-button">
                  <button className="btn btn-sm btn-success"  onClick={() => this.props.history.goBack()}> 
...
export default withTimeout(withRouter(AgentTradingWallet));                       