...
class ThriftLiquidationFields extends Component{
  ...
  render (){
    const { phoneLiquidate, cardLiquidate, phoneNumber, firstNine, lastNine, cardPin, phonePin, onChange, makingPayment } = this.props;
...
export default ThriftLiquidationFields;